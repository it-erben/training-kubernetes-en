...
- Lege ein Docker Network mit dem Namen `my-bridge` an und starte zwei Container mit Verbindung zum Network. (Verwende das `--network <NETWORK_NAME>`-Argument beim Start des Containers, um es mit einem Netzwerk zu verbinden)
