...
1. Readiness probe: waits five seconds before checking the endpoint for the first time.
2. Liveness probe: uses an initial delay of 10 seconds before the first check, then checks every
    30 seconds.
